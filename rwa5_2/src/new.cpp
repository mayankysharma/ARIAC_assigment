      ...
      planning_scene_()
{
  ...
  orders_sub_ = this->create_subscription<ariac_msgs::msg::Order>("/ariac/orders", 1,
                                                                  std::bind(&FloorRobotNode::orders_cb, this, std::placeholders::_1), options);

  competition_state_sub_ = this->create_subscription<ariac_msgs::msg::CompetitionState>("/ariac/competition_state", 1,
                                                                                        std::bind(&FloorRobotNode::competition_state_cb, this, std::placeholders::_1), options);
  ...
  kts1_camera_sub_ = this->create_subscription<ariac_msgs::msg::AdvancedLogicalCameraImage>(
      ...
      std::bind(&FloorRobotNode::kts1_camera_cb, this, std::placeholders::_1), options);
  ...
  kts2_camera_sub_ = this->create_subscription<ariac_msgs::msg::AdvancedLogicalCameraImage>(
      ...
      std::bind(&FloorRobotNode::kts2_camera_cb, this, std::placeholders::_1), options);
  ...
  left_bins_camera_sub_ = this->create_subscription<ariac_msgs::msg::AdvancedLogicalCameraImage>(
      ...
      std::bind(&FloorRobotNode::left_bins_camera_cb, this, std::placeholders::_1), options);
  ...
  right_bins_camera_sub_ = this->create_subscription<ariac_msgs::msg::AdvancedLogicalCameraImage>(
      ...
      std::bind(&FloorRobotNode::right_bins_camera_cb, this, std::placeholders::_1), options);
  ...
  floor_gripper_state_sub_ = this->create_subscription<ariac_msgs::msg::VacuumGripperState>(
      ...
      std::bind(&FloorRobotNode::floor_gripper_state_cb, this, std::placeholders::_1), options);
  ...
  ceiling_gripper_state_sub_ = this->create_subscription<ariac_msgs::msg::VacuumGripperState>(
      ...
      std::bind(&FloorRobotNode::ceiling_gripper_state_cb, this, std::placeholders::_1), options);
  ...
  as1_state_sub_ = this->create_subscription<ariac_msgs::msg::AssemblyState>(
      ...
      std::bind(&FloorRobotNode::as1_state_cb, this, std::placeholders::_1), options);
  ...
  as2_state_sub_ = this->create_subscription<ariac_msgs::msg::AssemblyState>(
      ...
      std::bind(&FloorRobotNode::as2_state_cb, this, std::placeholders::_1), options);
  ...
  as3_state_sub_ = this->create_subscription<ariac_msgs::msg::AssemblyState>(
      ...
      std::bind(&FloorRobotNode::as3_state_cb, this, std::placeholders::_1), options);
  ...
  as4_state_sub_ = this->create_subscription<ariac_msgs::msg::AssemblyState>(
      ...
      std::bind(&FloorRobotNode::as4_state_cb, this, std::placeholders::_1), options);

  agv1_status_sub_ = this->create_subscription<ariac_msgs::msg::AGVStatus>(
      "/ariac/agv1_status", 10,
      std::bind(&FloorRobotNode::agv1_status_cb, this, std::placeholders::_1), options);

  agv2_status_sub_ = this->create_subscription<ariac_msgs::msg::AGVStatus>(
      "/ariac/agv2_status", 10,
      std::bind(&FloorRobotNode::agv2_status_cb, this, std::placeholders::_1), options);

  agv3_status_sub_ = this->create_subscription<ariac_msgs::msg::AGVStatus>(
      "/ariac/agv3_status", 10,
      std::bind(&FloorRobotNode::agv3_status_cb, this, std::placeholders::_1), options);

  agv4_status_sub_ = this->create_subscription<ariac_msgs::msg::AGVStatus>(
      "/ariac/agv4_status", 10,
      std::bind(&FloorRobotNode::agv4_status_cb, this, std::placeholders::_1), options);
...
void FloorRobotNode::kts2_camera_cb(
    const ariac_msgs::msg::AdvancedLogicalCameraImage::ConstSharedPtr msg)
{
...
void FloorRobotNode::right_bins_camera_cb(
    const ariac_msgs::msg::AdvancedLogicalCameraImage::ConstSharedPtr msg)
{
...
void FloorRobotNode::floor_gripper_state_cb(
...
void FloorRobotNode::LogPose(geometry_msgs::msg::Pose p)
{
  tf2::Quaternion q(
      p.orientation.x,
      p.orientation.y,
...
geometry_msgs::msg::Pose FloorRobotNode::BuildPose(
...
geometry_msgs::msg::Pose FloorRobotNode::FrameWorldPose(std::string frame_id)
{
...
double FloorRobotNode::GetYaw(geometry_msgs::msg::Pose pose)
{
  tf2::Quaternion q(
      pose.orientation.x,
      pose.orientation.y,
...
geometry_msgs::msg::Quaternion FloorRobotNode::QuaternionFromRPY(double r, double p, double y)
{
  tf2::Quaternion q;
...
void FloorRobotNode::AddModelToPlanningScene(
    std::string name, std::string mesh_file, geometry_msgs::msg::Pose model_pose)
{
  ...
  std::string package_share_directory = ament_index_cpp::get_package_share_directory("test_competito");
...
void FloorRobotNode::AddModelsToPlanningScene()
{
  // Add bins
...
geometry_msgs::msg::Quaternion FloorRobotNode::SetRobotOrientation(double rotation)
{
  tf2::Quaternion tf_q;
...
bool FloorRobotNode::FloorRobotMovetoTarget()
{
...
bool FloorRobotNode::FloorRobotMoveCartesian(
...
void FloorRobotNode::FloorRobotWaitForAttach(double timeout)
{
...
void FloorRobotNode::FloorRobotSendHome()
{
...
bool FloorRobotNode::FloorRobotPickandPlaceTray(int tray_id, int agv_num)
{
...
bool FloorRobotNode::FloorRobotPickBinPart(ariac_msgs::msg::Part part_to_pick)
{
...
bool FloorRobotNode::FloorRobotPlacePartOnKitTray(int agv_num, int quadrant)
{
...
void FloorRobotNode::CeilingRobotSendHome()
{
...
bool FloorRobotNode::CeilingRobotSetGripperState(bool enable)
{
...
bool FloorRobotNode::CompleteOrders()
{
  ...
  while (true)
  {
    ...
    {
      FloorRobotNode::CompleteKittingTask(current_order_.kitting_task);
      kitting_agv_num = current_order_.kitting_task.agv_number;
    }
    else if (current_order_.type == ariac_msgs::msg::Order::ASSEMBLY)
    {
      FloorRobotNode::CompleteAssemblyTask(current_order_.assembly_task);
    }
    else if (current_order_.type == ariac_msgs::msg::Order::COMBINED)
    {
      FloorRobotNode::CompleteCombinedTask(current_order_.combined_task);
    ...
    FloorRobotNode::SubmitOrder(current_order_.id);
  }
  return success;
}


bool FloorRobotNode::CompleteKittingTask(ariac_msgs::msg::KittingTask task)
{
  FloorRobotSendHome();
...
bool FloorRobotNode::StartCompetition()
{
