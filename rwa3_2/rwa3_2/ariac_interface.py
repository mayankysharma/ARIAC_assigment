...
class AriacInterface(Node):
    ...
    def __init__(self, node_name):
        ...
        group_reentrant2 = ReentrantCallbackGroup()
        ...
        self.read_store_orders=ReadStoreOrders(self,AriacInterface.order_topic,self._orders,callback_group=group_reentrant2)
        self.custom_timer = CustomTimer(self)
        self.order_queue=deque(self._orders)
    ...
    def monitor_state_callback(self):
        ...
        if self.comp_state.competition_started and not self.comp_state.competition_ended:
            ...
            #  self.read_store_orders._orders_cb()
            # self.fufill_orders()
